...
Apply [Iron Rules](../iron-rules.md) — especially Principle 0 (intellectual integrity: flag findings that undermine the main thread's hypothesis rather than rationalizing them away) and Principle 8 (no claim without evidence — cite every source, never fabricate URLs or facts).
